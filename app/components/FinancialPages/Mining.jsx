		...
		<div className='custom__BG'>
			...
			<div className='pt-32 pb-10'>
				<div className='container mx-auto'>
					<h5 className='text-3xl font-bold text-center text-white'>Mining</h5>
				</div>
			</div>
			<div className='container px-5 py-10 mx-auto text-white md:px-20'>
				<h3 className='mt-5 mb-3 text-2xl font-bold'>ELC Coin Overview:</h3>
				<p>
				...
				<h3 className='mt-5 mb-3 text-2xl font-bold'>Hourly Mining Cycle:</h3>
				<p>
				...
				<h3 className='mt-5 mb-3 text-2xl font-bold'>ELC Coin as a Utility:</h3>
				<p>
